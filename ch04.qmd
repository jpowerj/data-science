...
![Source: <a href="https://xkcd.com/927/" target="_blank">XKCD #927</a>](/assets/img/ch03/standards.png){fig-align="center"}
:::
...
### R: The Tidyverse {data-name="The Tidyverse"}
...
<img src="/assets/img/ch04/tidyverse_half.png"></img>
:::
::: {.column width="50%"}
...
## Looking Forward {data-state="hide-menubar"}
