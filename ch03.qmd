...
<!-- <a href="./ch03.slides.html" target="_blank" class="h2">Open slides for chapter in new window &rarr;</a>

```{=html}
<iframe src="./ch03.slides.html" width="100%" height="400"></iframe>
``` -->
