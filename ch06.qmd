...
```{r, engine='tikz', opts.label="tikz_settings_fancy", fig.ext='svg', out.width='60%', label="convex-example-diagram", echo=FALSE}
\usetikzlibrary{calc}
...
<center>
```{r, engine='tikz', opts.label="tikz_settings_fancy", fig.ext='svg', out.width='60%', label="gradient-descent-diagram", echo=FALSE}
\usetikzlibrary{calc}
\usetikzlibrary{bayesnet}
\def\axisdefaultwidth{14cm}
...
![](/assets/img/ch05/backprop.png){fig-align="center"}

## Backing Up: What is a Neural Network? {#sec-nn-intro .smaller-title}
